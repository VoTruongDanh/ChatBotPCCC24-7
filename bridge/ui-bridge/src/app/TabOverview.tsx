  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="admin-section-desc">Chỉ số tổng hợp từ be-bridge, tự động làm mới mỗi 10 giây</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="admin-metric">
          ...
          <p className="text-xs mt-1" style={{ color: 'var(--c-text-3)' }}>Dựa trên số API key đang active</p>
        </div>
        ...
        <div className="admin-metric">
          ...
          <p className="text-lg font-bold mt-1" style={{ color: browserRunning ? 'var(--c-success)' : 'var(--c-text-4)' }}>
            {browserRunning ? 'Browser mở' : 'Chưa xác định'}
          </p>
      ...
      {status ? (
          ...
          <div className="admin-panel">
            ...
            <dl className="space-y-2.5 text-sm">
              {[
                ...
                <div key={k} className="flex justify-between gap-4">
                  <dt style={{ color: 'var(--c-text-3)' }}>{k}</dt>
                  <dd className="font-medium tabular truncate max-w-[180px]" style={{ color: 'var(--c-text)' }} title={v}>
                    {v}
                  </dd>
                </div>
              ))}
        ...
        <div className="admin-empty">
          ...
          <p className="text-xs mt-1 max-w-xs" style={{ color: 'var(--c-text-3)' }}>
            Kiểm tra kết nối be-bridge và phiên đăng nhập admin.
          </p>
